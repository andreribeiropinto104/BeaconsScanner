...
public class BeaconsScanCalibrationActivity extends AppCompatActivity implements ProximityManager.ProximityListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listBeacons.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                // NÃO ESTÁ ACTUALIZADO PARA CALIBRAÇÃO
                if (DeviceProfile.IBEACON == child.getDeviceProfile()) {
                    ...
                    Intent intentDetailsActivity = new Intent(BeaconsScanCalibrationActivity.this, IBeaconDetailsActivity.class);
                    ...
                    Intent intentDetailsActivity = new Intent(BeaconsScanCalibrationActivity.this, CalibrationActivity.class);
    ...
    public void startScan() {
        ...
        deviceManager.initializeScan(getOrCreateScanContext(), new OnServiceReadyListener() {
            ...
            public void onServiceReady() {
                deviceManager.attachListener(BeaconsScanCalibrationActivity.this);
            }
